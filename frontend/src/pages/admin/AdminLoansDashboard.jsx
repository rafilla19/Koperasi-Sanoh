    ...
    <div className="admin-loans-dash">
      ...
      <div className="ald-table-section">
        <div className="ald-table-controls">
          ...
          <button className="ald-print-btn" onClick={handleExportExcel} title="Ekspor ke Excel (CSV)">
            <Printer size={16} />
          </button>
          <div style={{ display: 'flex', gap: '8px' }}>
            <button className="ald-send-reminder-btn" onClick={handleSendReminder} title="Kirim Pengingat Terpilih">
              Kirim Pengingat
            </button>
            <button className="ald-send-reminder-btn" onClick={handleAutoSendAll} title="Kirim Otomatis Semua Tertunggak" style={{ background: '#f59e0b' }}>
